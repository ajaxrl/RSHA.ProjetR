...
::: {.justify}
Le graphique ci-dessous représente la relation entre le nombre de brevets déposés et le salaire annuel moyen proposé par différentes entreprises ou organisations. Les deux axes utilisent une échelle logarithmique : l'axe horizontal correspond au nombre de brevets, tandis que l'axe vertical montre les salaires annuels moyens en euros.
:::
...
```
::: {.justify}
Le graphique analyse la relation entre le nombre moyen de brevets et le salaire annuel moyen pour différents domaines technologiques identifiés par des codes IPC. 
